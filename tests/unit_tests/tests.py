...
class GraphTests(TestCase):
    ...
    def test_is_valid_path_returns_true(self):
        self._build_0123_graph()
        self.assertTrue(self.graph.is_valid_path('0'))
        self.assertTrue(self.graph.is_valid_path('0', '1'))
        self.assertTrue(self.graph.is_valid_path('0', '1', '3'))
        self.assertTrue(self.graph.is_valid_path('1', '3'))

    def test_is_not_valid_path_for_invalid_path(self):
        self._build_0123_graph()
        self.assertFalse(self.graph.is_valid_path('0', '3'))
        self.assertFalse(self.graph.is_valid_path('1', '2'))

    def test_is_valid_path_raises_for_backwards_path(self):
        self._build_0123_graph()
        self.assertFalse(self.graph.is_valid_path('1', '0'))
